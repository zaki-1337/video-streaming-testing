...
def home(request):
    video_data = [
        ...
        {"name": "Betty Crocker", "thumbnail_url": "https://i.ytimg.com/vi/cdbyRx11u_8/maxresdefault.jpg", "video_name": "Shotgun Willy - Betty Crocker feat. Yung Craka (Official Music Video)"},
    ]
